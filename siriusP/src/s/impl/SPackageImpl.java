...
public class SPackageImpl extends EPackageImpl implements SPackage {
	 ...
	 * @generated
	 */
	public EAttribute getsepet_TotalPrice() {
		return (EAttribute)sepetEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(sepetEClass, SEPET__TOTAL_PRICE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getsepet_TotalPrice(), ecorePackage.getEInt(), "totalPrice", null, 0, 1, sepet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
